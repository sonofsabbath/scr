...
int main(int a, char** b) {
	...
	char nazwa[10];
	sprintf(nazwa, "Xeno A");

	// po takiej nazwie mutex jest odszukiwany funkcja rt_mutex_bind
	// nazwa jest dostepna poza aplikacja, ktora ten mutex utworzyla
	rt_mutex_create(&mx, "mymux");

	rt_task_create(&task, nazwa, 0, 10, 0);
